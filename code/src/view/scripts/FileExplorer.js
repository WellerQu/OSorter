...
const map = ({ name = '文件名', type = FILE_TYPE.FILE, mediaPath = 'file:///Users/qiuwei/Movies/hnds026pl.jpg', isPlaying = false }) => (
  <div class={ [ locals.file, locals.focus ].join(' ') }>
    <div class={ locals.preview }>
      {
        type === FILE_TYPE.VIDEO && <video src={ mediaPath } width={ STYLE_VIDEO_SIZE.width } height={ STYLE_VIDEO_SIZE.height } />
      }
      {
        type === FILE_TYPE.VIDEO && !!!isPlaying && <div class={ locals.play } onclick={ (a) => a } />
      }
      {
        type === FILE_TYPE.VIDEO && !!isPlaying && <div class={ locals.pause } onclick={ (a) => a } />
      }
      {
